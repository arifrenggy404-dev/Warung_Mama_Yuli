...
<div class="container-fluid px-2 px-md-3">
    <h3 class="fw-bold mb-3 fs-4 fs-md-3">Tambah Jadwal Shift</h3>

    <form action="{{ route('jadwal.store') }}" method="POST" class="card p-3 p-md-4 shadow-sm border-0">
        @csrf
        ...
        <div class="row g-3">
            ...
            <div class="col-md-12 col-12">
                ...
                <input type="text" name="keterangan" value="{{ old('keterangan') }}" class="form-control @error('keterangan') is-invalid @enderror" placeholder="Contoh: Lembur / Tukar Shift">
