...
<div class="container-fluid px-2 px-md-3">
    <h3 class="fw-bold text-dark mb-3 fs-4 fs-md-3">Tambah Menu Baru</h3>
            ...
            <div class="row g-3">
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="nama_menu" class="form-control @error('nama_menu') is-invalid @enderror" 
                        value="{{ old('nama_menu') }}" placeholder="Contoh: Mie Ayam Bakso" required>
                    @error('nama_menu')
                ...
                <div class="col-12 col-md-6">
                    ...
                    <select name="kategori" class="form-select @error('kategori') is-invalid @enderror" required>
                        ...
                        <option value="Mie Ayam" @selected(old('kategori') == 'Mie Ayam')>Mie Ayam</option>
                        <option value="Bakso" @selected(old('kategori') == 'Bakso')>Bakso</option>
